...
<head>
    ...
    $(function() {
    	$('#btn_submit').click(function(){
    		if($('#editForm').valid()){
	    		$.post('<%=basePath%>admin/doResetPwd', $('#editForm').serialize(), function(data){
...
<body>
    ...
    <div class="content">
        <table border="0" cellpadding="0" cellspacing="0" class="table">
            <tr>
                <td width="120px" align="right" height="25px">原密码：</td>
                <td><input type="password" name="password" style="width:200px;" class="{required:true,minlengthCN:6,maxlengthCN:50,alphanumeric:true}"/></td>
            </tr>
            <tr>
                <td align="right" height="25px">新密码：</td>
                <td>
                	<input type="password" id="admin_newPassword" name="newPassword" style="width:200px;" class="{required:true,minlengthCN:6,maxlengthCN:50,alphanumeric:true}"/>
                </td>
            </tr>
            <tr>
                <td align="right" height="25px">再输一遍：</td>
                <td>
                	<input type="password" style="width:200px;" class="{required:true,minlengthCN:6,maxlengthCN:50,alphanumeric:true,equalTo:'#admin_newPassword'}"/>
                </td>
            </tr>
            <tr>

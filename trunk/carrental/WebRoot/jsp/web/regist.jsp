			...
			<table width="100%" border="0" cellspacing="26" cellpadding="0">
				...
				<tr>
					...
					<td><input type="text" name="phone"
						class="{required:true,phoneCN:true,maxlengthCN:50} input" /> 请输入您的手机号码，以便我们向您确认预订信息</td>
				</tr>
				<tr>
					<td align="right"><font>*</font>手机验证码：</td>
					<td><input type="text" name="phoneValidNo"
						class="{required:true,digits:true,minlength:6,maxlength:6} input" /><input type="button" id="getPhoneValidNo"
						class="input" value="获取验证码" /> 请输入验证码</td>
				</tr>
				<tr>
					<td align="right"><font>*</font>密码：</td>
					<td><input type="password" name="password" id="admin_password"
				...
				<tr>
					...
					<td><input type="password"
						class="{required:true,minlengthCN:6,maxlengthCN:50,alphanumeric:true,equalTo:'#admin_password'} input" /> 请再一次输入密码</td>
				</tr>
				<tr>
